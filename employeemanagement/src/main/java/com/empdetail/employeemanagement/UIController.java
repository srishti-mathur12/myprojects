...
public class UIController {
	...
	public String findPaginated(@PathVariable int pageno, Model m) {
		Page<Employee> emplist = employeeService.getEmployeeByPaginate(pageno, 10);
	...
	public String getEmployeeByName(@RequestParam("search") String name, @PathVariable int pageno, Model m) {
		Page<Employee> empList = employeeService.findEmployeeByName(name, pageno, 10);
		m.addAttribute("employee", empList);
